...
"""
custom:
  bert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base
  device: cpu
  is_half: false
  t2s_weights_path: GPT_SoVITS_Inference/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt
  vits_weights_path: GPT_SoVITS_Inference/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth
  version: v2
v1:
  bert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base
  device: cpu
  is_half: false
  t2s_weights_path: GPT_SoVITS_Inference/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt
  vits_weights_path: GPT_SoVITS_Inference/pretrained_models/s2G488k.pth
  version: v1
v2:
  bert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base
...
v3:
  ...
  device: cpu
  is_half: false
  t2s_weights_path: GPT_SoVITS_Inference/pretrained_models/s1v3.ckpt
  vits_weights_path: GPT_SoVITS_Inference/pretrained_models/s2Gv3.pth
  version: v3
v4:
  bert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base
  ...
  t2s_weights_path: GPT_SoVITS_Inference/pretrained_models/s1v3.ckpt
  version: v4
  vits_weights_path: GPT_SoVITS_Inference/pretrained_models/gsv-v4-pretrained/s2Gv4.pth
"""
...
class TTS_Config:
    default_configs = {
        ...
        "v2Pro": {
            ...
            "version": "v2Pro",
            "t2s_weights_path": "GPT_SoVITS_Inference/pretrained_models/s1v3.ckpt",
            "vits_weights_path": "GPT_SoVITS_Inference/pretrained_models/v2Pro/s2Gv2Pro.pth",
            "cnhuhbert_base_path": "GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base",
            "bert_base_path": "GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large",
        },
        "v2ProPlus": {
            ...
            "version": "v2ProPlus",
            "t2s_weights_path": "GPT_SoVITS_Inference/pretrained_models/s1v3.ckpt",
            "vits_weights_path": "GPT_SoVITS_Inference/pretrained_models/v2Pro/s2Gv2ProPlus.pth",
            "cnhuhbert_base_path": "GPT_SoVITS_Inference/pretrained_models/chinese-hubert-base",
            "bert_base_path": "GPT_SoVITS_Inference/pretrained_models/chinese-roberta-wwm-ext-large",
        },
    }
    ...
    def __init__(self, configs: Union[dict, str] = None):
        # 设置默认配置文件路径
        configs_base_path: str = "GPT_SoVITS_Inference/configs/"
    ...
    def init_vocoder(self, version: str):
        if version == "v3":
            ...
            self.vocoder = BigVGAN.from_pretrained(
                "%s/GPT_SoVITS_Inference/pretrained_models/models--nvidia--bigvgan_v2_24khz_100band_256x" % (now_dir,),
            ...
            state_dict_g = torch.load(
                "%s/GPT_SoVITS_Inference/pretrained_models/gsv-v4-pretrained/vocoder.pth" % (now_dir,),
                map_location="cpu",
                weights_only=False,
            )
